...
object SettradeRepository {
    ...
    private const val PROXY_PREFIX = "https://api.allorigins.win/raw?url="
    ...
    suspend fun fetchLiveSetIndex(): FetchResult = withContext(Dispatchers.IO) {
        val attempts = listOf(
            ...
            PROXY_PREFIX + java.net.URLEncoder.encode(SET_OR_TH_URL, "UTF-8") to ::parseSetOrTh,
            PROXY_PREFIX + java.net.URLEncoder.encode(SETTRADE_URL, "UTF-8") to ::parseSettrade
        )
